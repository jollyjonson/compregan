...
class CopyThisFileToDirectoryTest(unittest.TestCase):
    ...
    def test_copying_works_as_expected(self):
        ...
        try:
            ...
            file_content = f"from compregan.util import copy_this_file_to_directory\n" \
            ...
            with subprocess.Popen(['python', file_path_before_copying]) as proc:
                proc.wait()
                self.assertEqual(0, proc.returncode)

            file_path_after_copying = os.path.join(dir_inside_tmp_dir, file_name)
