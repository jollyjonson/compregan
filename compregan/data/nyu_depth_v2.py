...
DEFAULT_DATASET_PATH = os.path.join(
    TFDS_DEFAULT_DATA_DIR, "nyu_depth_v2_labeled", "nyu_depth_v2_labeled.mat"
)
...
SPLIT_SLICES = {
    ...
    "validation": slice(
        -(NUM_VALIDATION_ITEMS + NUM_TEST_ITEMS), -NUM_TEST_ITEMS
    ),
...
def load_nyu_depth_dataset_with_semantic_labels(
    ...
    dataset_path: Optional[Union[str, os.PathLike]] = DEFAULT_DATASET_PATH,
) -> tf.data.Dataset:
    assert os.path.exists(dataset_path)  # type: ignore
