...
class HyperParameters:
    ...
    num_filters_per_layer_encoder = (60, 120, 240, 480, 960) if not debug else (1, 3, 12)
...
compression_gan = CompressionGAN(
    ...
    loss_terms=(MSE(10.),
                ...
                FeatureMatchingLoss(model_builder.discriminator, 10.)),
...
city_scapes_dataset_train = extract_and_preprocess_images(tfds.load('cityscapes', split='train'),
                                                          **dataset_preprocesing_kwargs)

city_scapes_dataset_val = extract_and_preprocess_images(tfds.load('cityscapes', split='validation'),
                                                        **dataset_preprocesing_kwargs)
